    ...
    while (i--) {
        ...
        if (val && 'Object' === val.constructor.name) {
            ...
            if (schema && schema.caster && op in castOps) {
                ...
                if (this.model.schema.pathType(pathToCheck) === 'adhocOrUndefined' && !this.model.schema.hasMixedParent(pathToCheck) &&
                    this.model.schema.pathType(positionalPath) === 'adhocOrUndefined' && !this.model.schema.hasMixedParent(positionalPath)) {
                    if (strict === 'throw') {
